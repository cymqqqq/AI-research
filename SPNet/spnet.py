...
from .base import Pyramid,StripPooling
from .fcn import FCNHead

class SPNet(BaseNet):
    def __init__(self,nclass,backbone,pretrained,criterion=None,aux=True,norm_layer=nn.BatchNorm2d,
                spm_on=False,**kwargs):
    ...
    def forward(self,x,y=None):
        ...
        if self.training:
            ...
            main_loss=self.criterion(aux,y)
        else:
            return x
